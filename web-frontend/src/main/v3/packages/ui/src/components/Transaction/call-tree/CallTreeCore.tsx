...
export interface CallTreeCoreProps {
  data: TransactionCallTree.CallStackKeyValueMap[];
  mapData: TransactionCallTree.CallStackKeyValueMap[];
...
export const CallTreeCore = ({ data, mapData, metaData }: CallTreeCoreProps) => {
  ...
  useUpdateEffect(() => {
    let filteredList: TransactionCallTree.CallStackKeyValueMap[] = [];
    if (filter === 'hasException') {
