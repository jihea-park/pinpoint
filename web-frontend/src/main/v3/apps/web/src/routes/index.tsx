...
import ScatterFullScreen from '@pinpoint-fe/web/pages/ScatterFullScreen';
import {
...
import FilteredMap from '@pinpoint-fe/web/pages/FilteredMap';
import { BASE_PATH, APP_PATH } from '@pinpoint-fe/ui/constants';
import NotFound from '@pinpoint-fe/web/pages/NotFound';
import ErrorAnalysis from '@pinpoint-fe/web/pages/ErrorAnalysis';
import { errorAnalysisRouteLoader } from './loader/errorAnalysis';
import ApiCheck from '@pinpoint-fe/web/pages/ApiCheck';
import { urlStatisticRouteLoader } from './loader/urlStatistic';
import UrlStatistic from '@pinpoint-fe/web/pages/UrlStatistic';
import SystemMetric from '@pinpoint-fe/web/pages/SystemMetric';
import { systemMetricRouteLoader } from './loader/systemMetric';
import General from '@pinpoint-fe/web/pages/config/General';
import Experimentals from '@pinpoint-fe/web/pages/config/Experimentals';
import TransactionList from '@pinpoint-fe/web/pages/TransactionList';
import TransactionDetail from '@pinpoint-fe/web/pages/TransactionDetail';
...
import Inspector from '@pinpoint-fe/web/pages/Inspector';
import ThreadDump from '@pinpoint-fe/web/pages/ThreadDump';
import OpenTelemetry from '@pinpoint-fe/web/pages/OpenTelemetry';
import Help from '@pinpoint-fe/web/pages/config/Help';
import Installation from '@pinpoint-fe/web/pages/config/Installation';
import UserGroup from '@pinpoint-fe/web/pages/config/UserGroup';
import Users from '@pinpoint-fe/web/pages/config/Users';
import Alarm from '@pinpoint-fe/web/pages/config/Alarm';
import Webhook from '@pinpoint-fe/web/pages/config/Webhook';
import AgentManagement from '@pinpoint-fe/web/pages/config/AgentManagement';
import AgentStatistic from '@pinpoint-fe/web/pages/config/AgentStatistic';
